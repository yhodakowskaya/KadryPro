...
urlpatterns = [
    ...
    path('users/<int:user_pk>/contracts/', views.ContractListCreateView.as_view(), name='contract-list'),
    path('users/<int:user_pk>/contracts/<int:pk>/', views.ContractDetailView.as_view(), name='contract-detail'),
    path('users/import/parse/', views.UserImportParseView.as_view(), name='user-import-parse'),
    path('users/import/confirm/', views.UserImportConfirmView.as_view(), name='user-import-confirm'),
